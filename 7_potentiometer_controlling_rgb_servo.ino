...
void loop() {
  ...
  if (potentiometer <= (171*0) ) {
    myServo.write(0); 
    rgbRed();
  }
  else if (potentiometer <= (171*1) ) {
    myServo.write(30);
    rgbOrange();
  }
  else if (potentiometer <= (171*2) ) {
    myServo.write(60);
    rgbYellow();
  }
  else if (potentiometer <= (171*3) ) {
    myServo.write(90);
    rgbGreen();
  }
  else if (potentiometer <= (171*4) ) {
    myServo.write(120);
    rgbBlue();
  }
  else if (potentiometer <= (171*5) ) {
    myServo.write(150);
    rgbIndigo();
  }
  else if (potentiometer <= (171*6) ) {
    myServo.write(180);
    rgbViolet();
  }
